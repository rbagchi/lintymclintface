...
echo "Running linter on json-simple project..."
REPO_DIR="tmp_json_simple_repo"

# Clone the repository if it doesn't exist
if [ ! -d "${REPO_DIR}" ]; then
  echo "Cloning json-simple into ${REPO_DIR}..."
  git clone https://github.com/fangyidong/json-simple.git ${REPO_DIR}
  if [ $? -ne 0 ]; then
